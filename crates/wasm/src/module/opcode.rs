...
pub enum Opcode {
    ...
    F32x4Splat = 0xFD_10,
    F64x2Splat = 0xFD_11,
    I8x16ExtractLaneS = 0xFD_12,
    I8x16ExtractLaneU = 0xFD_13,
    I16x8ExtractLaneS = 0xFD_14,
    I16x8ExtractLaneU = 0xFD_15,
    I32x4ExtractLane = 0xFD_16,
    I64x2ExtractLane = 0xFD_17,
    F32x4ExtractLane = 0xFD_18,
    F64x2ExtractLane = 0xFD_19,
    I8x16ReplaceLane = 0xFD_1A,
    I16x8ReplaceLane = 0xFD_1B,
    I32x4ReplaceLane = 0xFD_1C,
    I64x2ReplaceLane = 0xFD_1D,
    F32x4ReplaceLane = 0xFD_1E,
    F64x2ReplaceLane = 0xFD_1F,
...
impl Opcode {
    pub(crate) fn from_u8(value: u8) -> Result<Self, WasmParseError> {
        match value {
            ...
            0xFD => match value {
                0x00 => Ok(Opcode::V128Load),
                0x0B => Ok(Opcode::V128Store),
                0x0C => Ok(Opcode::I8x16Splat),
                0x0D => Ok(Opcode::I16x8Splat),
                0x0E => Ok(Opcode::I32x4Splat),
                0x0F => Ok(Opcode::I64x2Splat),
                0x10 => Ok(Opcode::F32x4Splat),
                0x11 => Ok(Opcode::F64x2Splat),
                0x12 => Ok(Opcode::I8x16ExtractLaneS),
                0x13 => Ok(Opcode::I8x16ExtractLaneU),
                0x14 => Ok(Opcode::I16x8ExtractLaneS),
                0x15 => Ok(Opcode::I16x8ExtractLaneU),
                0x16 => Ok(Opcode::I32x4ExtractLane),
                0x17 => Ok(Opcode::I64x2ExtractLane),
                0x18 => Ok(Opcode::F32x4ExtractLane),
                0x19 => Ok(Opcode::F64x2ExtractLane),
                0x1A => Ok(Opcode::I8x16ReplaceLane),
                0x1B => Ok(Opcode::I16x8ReplaceLane),
                0x1C => Ok(Opcode::I32x4ReplaceLane),
                0x1D => Ok(Opcode::I64x2ReplaceLane),
                0x1E => Ok(Opcode::F32x4ReplaceLane),
                0x1F => Ok(Opcode::F64x2ReplaceLane),
                _ => Err(WasmParseError::InvalidOpcode(value)),
            },
            _ => Err(WasmParseError::InvalidOpcode(value)),
        }
